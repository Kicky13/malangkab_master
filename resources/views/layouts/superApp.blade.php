            ...
            <ul class="nav">
                ...
                <li>
                    ...
                    <div class="collapse" id="pertanyaan">
                        <ul class="nav">
                            <li>
                                <a href="/kuesioner/dimension">Dimension</a>
                            </li>
                            <li>
                                <a href="/kuesioner">Question</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="laporan">
                        <ul class="nav">
                            <li>
                                <a href="/report/response">Response Result</a>
                            </li>
                            <li>
                                <a href="/report/analysis">Analysis</a>
                            </li>
                            <li>
                                <a href="/report/suggest">Suggestion</a>
                            </li>
                        </ul>
                    </div>
                </li>
